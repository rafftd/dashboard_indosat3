...
class AdminPurchaseOrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Filter by markom_branch_id for markom branch users
        if (auth()->user() && auth()->user()->role === 'markom_branch') {
            $query->where('markom_branch_id', auth()->id())
    ...
    public function store(Request $request)
    {
        try {
            $request->validate([
                ...
                'markom_branch_id' => 'required|exists:users,id',
        ...
        try {
            ...
            $purchaseOrder = PurchaseOrder::create([
                ...
                'markom_branch_id' => $request->markom_branch_id,
